...
if(isset($_POST['login'])) {
	 $myemail = mysqli_real_escape_string($conn,$_POST['inputEmail']);
	  ...
	  $sql = "SELECT Register_Id,FirstName,LastName FROM tbl_register WHERE Email = '$myemail' and StudentPassword = '$mypassword'";
...
<div class="container">
        <div class="panel panel-primary" style="width:750px;margin:0px auto">
             ...
             <div class="form-group">
                    ...
                    <a class="btn btn-link" href="ForgotPassword.php">Forgot Your Password?</a>
					<input type="button" class="btn btn-success" id="signUp" value="SignUp" onclick="relocate_home()">
                </div>
            </form>
			</div>
		</div>
